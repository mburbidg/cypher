...
func TestNumbers(t *testing.T) {
	tests := map[string]struct {
		...
		"zero:-n+":          {"-0+", []TokenType{Dash, DecimalInteger, Plus, EndOfInput}},
		...
		"integer:-n+":       {"-240+", []TokenType{Dash, DecimalInteger, Plus, EndOfInput}},
		...
		"double:-0.x+":      {"-0.1+", []TokenType{Dash, Double, Plus, EndOfInput}},
		...
		"double:-.x+":       {"-.15+", []TokenType{Dash, Double, Plus, EndOfInput}},
		...
		"double:-xEx+":      {"-10E3+", []TokenType{Dash, Double, Plus, EndOfInput}},
		...
		"double:-x.xEx+":    {"-1.35E3+", []TokenType{Dash, Double, Plus, EndOfInput}},
...
func TestPunctuation(t *testing.T) {
	tests := map[string]struct {
		...
		"punctuation:2":        {"+-*/%^$:", []TokenType{Plus, Dash, Star, ForwardSlash, Percent, Caret, DollarSign, Colon, EndOfInput}},
		"punctuation:2/ws":     {"+ - * / % ^ $ :", []TokenType{Plus, Dash, Star, ForwardSlash, Percent, Caret, DollarSign, Colon, EndOfInput}},
		...
		"illegal character":    {"a—b", []TokenType{Identifier, Illegal, Identifier, EndOfInput}},
	}
